...
class TestMTChannelToXML01HY(unittest.TestCase):
    ...
    def test_location(self):
        self.assertEqual(self.base_xml_channel.latitude, 
                         self.test_xml_channel.latitude)
        self.assertEqual(self.base_xml_channel.longitude, 
                         self.test_xml_channel.longitude)
        self.assertEqual(self.base_xml_channel.elevation, 
                         self.test_xml_channel.elevation)
        self.assertEqual(self.base_xml_channel.depth, 
                         self.test_xml_channel.depth)
        
    def test_time_period(self):
        self.assertEqual(self.base_xml_channel.start_date, 
                         self.test_xml_channel.start_date)
        self.assertEqual(self.base_xml_channel.end_date, 
                         self.test_xml_channel.end_date)
    def test_code(self):
        # the codes are not the same because the azimuth is more than 5 degrees from E 
        self.assertNotEqual(self.base_xml_channel.code, 
                         self.test_xml_channel.code)
        self.assertEqual(self.base_xml_channel.alternate_code, 
                         self.test_xml_channel.alternate_code)
        
    def test_sensor(self):
        self.assertEqual(self.base_xml_channel.sensor.type, 
                         self.test_xml_channel.sensor.type)
        self.assertEqual(self.base_xml_channel.sensor.model, 
                         self.test_xml_channel.sensor.model)
        self.assertEqual(self.base_xml_channel.sensor.manufacturer, 
                         self.test_xml_channel.sensor.manufacturer)
        self.assertEqual(self.base_xml_channel.sensor.serial_number, 
                         self.test_xml_channel.sensor.serial_number)
        self.assertEqual(self.base_xml_channel.sensor.description, 
                         self.test_xml_channel.sensor.description)
        
    def test_units(self):
        self.assertEqual(self.base_xml_channel.calibration_units, 
                         self.test_xml_channel.calibration_units)
        self.assertEqual(self.base_xml_channel.calibration_units_description, 
                         self.test_xml_channel.calibration_units_description)
        
    def test_sample_rate(self):
        self.assertEqual(self.base_xml_channel.sample_rate, 
                         self.test_xml_channel.sample_rate)
        
    def test_azimuth(self):
        self.assertEqual(self.base_xml_channel.azimuth, 
                         self.test_xml_channel.azimuth)
        self.assertEqual(self.base_xml_channel.dip, 
                         self.test_xml_channel.dip)
        
    def test_types(self):
        self.assertEqual(self.base_xml_channel.types, 
                         self.test_xml_channel.types)
...
class TestMTChannelToXML02HX(unittest.TestCase):
    ...
    def test_code(self):
        ...
        self.assertNotEqual(self.base_xml_channel.code, 
                         self.test_xml_channel.code)
        self.assertEqual(self.base_xml_channel.alternate_code.lower(), 
    ...
    def test_comments(self):
        for comment_base, comment_test in zip(self.base_xml_channel.comments,
                                              self.test_xml_channel.comments):
