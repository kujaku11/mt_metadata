...
class TestFAPTranslation(unittest.TestCase):
    ...
    def test_translation_fap_elements(self):
        fap_0 = self.inventory.networks[0].stations[0].channels[0].response.response_stages[0]
        fap_1 = self.new_inventory.networks[0].stations[0].channels[0].response.response_stages[0]
    ...
    def test_mt_translation_fap_elements(self):
        fap = self.inventory.networks[0].stations[0].channels[0].response.response_stages[0]
