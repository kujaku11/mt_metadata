...
<<<<<<<< HEAD:tests/processing/fcs/test_decimation.py
        assert len(freqs) == dl1.window.num_samples / 2
========
        assert (len(freqs) == dl1.stft.window.num_samples/2)

>>>>>>>> main:tests/transfer_functions/processing/fcs/test_decimation.py
...
class TestDecimationAuroraDecimationLevel(unittest.TestCase):
    ...
    def test_has_required_channels_false(self):
        dl = Decimation()
<<<<<<<< HEAD:tests/processing/fcs/test_decimation.py
        self.assertEqual(False, dl.has_fcs_for_aurora_processing(self.adl, None))

    def test_has_required_channels_true(self):
        self.assertEqual(True, self.dl.has_fcs_for_aurora_processing(self.adl, None))
========
        self.assertEqual(
...
<<<<<<<< HEAD:tests/processing/fcs/test_decimation.py
        self.assertEqual(False, self.dl.has_fcs_for_aurora_processing(self.adl, None))
