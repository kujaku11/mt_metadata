...
class TestBandDefault(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        self.min_freq = 2.0
        self.max_freq = 3.0
        self.band = Band(frequency_min=self.min_freq, frequency_max=self.max_freq)
    ...
    def test_center_frequency_geometric(self):
        ...
        with self.subTest("frequency"):
            self.assertAlmostEqual(self.band.center_frequency, 2.449489742783178)
        with self.subTest("period"):
            self.assertAlmostEqual(self.band.center_period, 1.0 / 2.449489742783178)
