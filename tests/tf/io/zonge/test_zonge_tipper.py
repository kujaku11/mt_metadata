...
class TestAVGHeader(unittest.TestCase):
    ...
    def test_mt_edit(self):
        ...
        self.assertDictEqual(
            mt_edit, self.header.m_t_edit.to_dict(single=True)
        )
    ...
    def test_center_location(self):
        self.assertListEqual(
            [311288.0, 4281879.0, 1548.1], self.header.center_location
        )
...
class TestAVG(unittest.TestCase):
    ...
    def test_t_first_element(self):
        t1 = np.array(
            [[923.7823987 - 524.50678723j, -22.74427485 - 18.94823397j]]
        )
