...
class TestFAPFilter(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.pz = PoleZeroFilter(units_in="volts", units_out="volts", name="example_zpk_response")
    ...
    def test_complex_response(self):
        ...
        with self.subTest(msg="test amplitude"):
            ...
            slope = np.log10(cr_amp[index_1]/cr_amp[index_0]) / np.log10(self.cr.frequencies[index_1] / self.cr.frequencies[index_0])
