    ...
    def test_z(self):
        ...
        with self.subTest(msg="first element"):
            self.assertTrue(
                np.isclose(
                    self.tf.impedance[0],
                    np.array([[  8.260304 +9.270211j,  24.263760-26.85942j ],
        ...
        with self.subTest(msg="last element"):
            self.assertTrue(
                np.isclose(
                    self.tf.impedance[-1],
                    np.array([[ 112.484200 +217.4326j, -152.321200 -887.0555j],
