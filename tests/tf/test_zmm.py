...
class TestTranslateZmm(unittest.TestCase):
    ...
    def test_channels_recorded(self):
        self.assertListEqual(['hx', 'hy', 'hz', 'ex', 'ey'], 
                             self.zmm_obj.channels_recorded)
    def test_hx(self):
    ...
    def test_transfer_function(self):
        ...
        with self.subTest("testing dtype", i=2):
            self.assertEqual(self.zmm_obj.transfer_functions.dtype.type,
                             np.complex64)
    ...
    def test_sigma_s(self):
        ...
        with self.subTest("testing dtype", i=2):
            self.assertEqual(self.zmm_obj.sigma_s.dtype.type,
                             np.complex64)
    ...
    def test_sigma_e(self):
        ...
        with self.subTest("testing dtype", i=2):
            self.assertEqual(self.zmm_obj.sigma_e.dtype.type,
                             np.complex64)
