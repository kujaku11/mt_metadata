...
.. container::
   ...
   .. table::
       ...
       | **Units**: None                              |                                               | lter]          |
       |                                              |                                               |                |
       | **Type**: list[mt_metadata.timeseries.filters|                                               |                |
       | .pole_zero_filter.PoleZeroFilter |           |                                               |                |
       | mt_metadata.timeseries.filters.coef          |                                               |                |
       | ficient_filter.CoefficientFilter |           |                                               |                |
       | mt_metadata.timeseries.filters.time          |                                               |                |
       | _delay_filter.TimeDelayFilter | mt_          |                                               |                |
       |                                              |                                               |                |
       | **Default**: list                            |                                               |                |
       |                                              |                                               |                |
       |                                              |                                               |                |
