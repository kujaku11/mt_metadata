...
from mt_metadata.utils.exceptions import MTvalidatorsError
...
class TestValidators(unittest.TestCase):
    ...
    def test_validate_header_fail(self):
        self.assertRaises(MTvalidatorsError, validators.validate_header, self.header_fail)
    ...
    def test_validate_required_fail(self):
        self.assertRaises(MTvalidatorsError, validators.validate_required, self.required_fail)
    ...
    def test_validate_type_fail(self):
        self.assertRaises(MTvalidatorsError, validators.validate_type, self.type_fail)
    ...
    def test_validate_units_fail(self):
        self.assertRaises(MTvalidatorsError, validators.validate_units, self.units_fail)
    ...
    def test_validate_style_fail(self):
        self.assertRaises(MTvalidatorsError, validators.validate_style, self.style_fail)
    ...
    def test_validate_attribue_fail(self):
        self.assertRaises(MTvalidatorsError, validators.validate_attribute, self.name_fail)
