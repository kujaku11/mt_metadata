...
class DecimationLevel(Base):
    ...
    def bands_dataframe(self):
        ...
        """
        from mt_metadata.transfer_functions.processing.aurora.frequency_band import df_from_bands
    ...
    def windowing_scheme(self):
        from mt_metadata.transfer_functions.processing.aurora.windowing_scheme import WindowingScheme
